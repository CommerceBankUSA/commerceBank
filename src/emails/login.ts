...
<body>
  <div class="email-container">
    ...
    <div class="content">
      ...
      <p>If this was you, no further action is needed. If not, please secure your account immediately by resetting your password, or contact support: <span class="footerSpan" style="color: #1D9B5E">support@cbshvault.com</span></p>
    </div>
  </div>
  <div class="footer">
    <p><span class="footerSpan">CBSH Bank</span> — Your secure banking provider</p>
    <p>Need help? <a href="mailto:support@cbshvault.com">Contact Support</a></p>
